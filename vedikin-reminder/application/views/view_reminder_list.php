	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-header filter_div">
				<!-- Fillter area -->
				<form class="filter_form" id="frmListDataFilter" action="<?php echo SITE_URL ?>search_reminder" method="post">
					<div class="row">
						<div class="col-sm-2">
						...
						<div class="col-sm-2">
							...
							<a href="<?php echo SITE_URL.'reminder-list';?>" class="btn btn-info">Reset</a>
						</div>
					</div>
				</form>
				<!-- Fillter area end-->
			...
			<div class="box-body">
				...
				<?php } ?>
                    ...
                    <tbody>
						...
						<td><?php echo date('Y-m-d',strtotime($reminder->modified_datetime)); ?></td>
						<td><?php echo $reminder->user_name; ?></td>
						<td><?php echo getIsactiveButtonForList($reminder->is_active,$reminder->reminder_id,DB_PREFIX.'reminder','reminder_id'); ?></td>
						<td>
							<?php 
								if (in_array("3", $user_rights)) {
									echo '<div class="btn-group" id="action">'.getActionButtonForList($reminder->reminder_id,'reminder',array("E"))."</div>"; 
								}
								if(in_array("4", $user_rights)) { 
									echo '<div class="btn-group" id="action">'.getActionButtonForList($reminder->reminder_id,'reminder',array("D"))."</div>";
								}
