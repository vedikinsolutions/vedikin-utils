...
<div class="row">
   ...
   <div class="col-md-12">
      ...
      <div class="box box-primary">
         ...
         <!-- form start -->
         <form role="form" method="post" name="menu" action="<?php echo SITE_URL ?>controller_update_history/save_update" enctype="multipart/form-data">
         <input type="hidden" name="history_id" value="<?php echo $get_data[0]->update_history_id; ?>">
         <div class="box-body">
               <div class="form-group">
                  <label for="reminder">Reminder</label>
                    <select name="reminder" id="reminder" class="form-control">
                        <?php foreach($reminders as $reminder){ 
                            echo "<option value='".$reminder->reminder_id."'".(($get_data[0]->reminder_id) ?'selected':'').">".$reminder->reminder_title."</option>";
                         } ?>
                    </select>
               </div>
               <div class="form-group">
                  <label for="reminder_date">Next Reminder Date<span class="text text-danger">*</span></label>
                  <input type="text" name="reminder_date" id="reminder_date" class="form-control" value="<?php echo date('Y-m-d',strtotime($get_data[0]->next_reminder_date)); ?>">
