	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-header filter_div">
				<!-- Fillter area -->
				<form class="filter_form" id="frmListDataFilter" action="<?php echo SITE_URL ?>search_points" method="post">
					<div class="row">
						<div class="col-sm-2">
						...
						<td>
							<?php 
								if (in_array("3", $user_rights)) {
									echo '<div class="btn-group" id="action">'.getActionButtonForList($points->points_id,'points',array("E"))."</div>"; 
								}
								if(in_array("4", $user_rights)) { 
									echo '<div class="btn-group" id="action">'.getActionButtonForList($points->points_id,'points',array("D"))."</div>";
								}
								if(in_array("1", $user_rights)) { 
									echo '<div class="btn-group" id="action">'.getActionButtonForList($points->points_id,'points',array("V"))."</div>";
								}
							?>
						</td>
